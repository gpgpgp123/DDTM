...
from networks import yvit_seg_configs as configs
...
class Embeddings(nn.Module):
    ...
    def __init__(self, config, img_size, backbone, in_channels=4):
...
class DecoderCup(nn.Module):
    ...
    def forward(self, hidden_states, features=None):
        ...
        # x1 = self.conv_last(torch.cat([x1, features[0]],
        #                dim=1))  # Concat the 1-channal output_map of ViT branch to assist CNN branch training
        return x1, x2
